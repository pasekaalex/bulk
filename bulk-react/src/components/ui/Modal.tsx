...
export function Modal({ open, onClose, title, children }: ModalProps) {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-md bg-gradient-to-b from-purple-darkest to-purple-darker border-2 border-purple-DEFAULT rounded-2xl p-6 animate-scale-in max-h-[85vh] overflow-y-auto">
        <button
          onClick={onClose}
